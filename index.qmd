...
<video controls autoplay="1" playsinline src="assets/ida.webm" title="Inspect Element" class="quarto-cover-image img-fluid" alt="A Google Knowlege Panel of Ida Tarbell stained different colors from an audit.  " controls=""><a href="http://localhost:4674/assets/ida.webm">Video</a></video>  
